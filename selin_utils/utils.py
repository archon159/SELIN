...
def parse_arguments(
    ...
    parser.add_argument(
        '--reg_lambda', type=float, default=0.2,
    ...
    parser.add_argument(
        '--avoid_dummy', action='store_true',
        help='Avoid dummy'
    )
    
    parser.add_argument(
        '--num2cat', action='store_true',
        help='Use more finegrained atoms for tabular dataset'
    )
    
    parser.add_argument(
        '--noise_ratio', type=float, default=0.,
        help='Noisy label ratio'
    )
